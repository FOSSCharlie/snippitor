/*
 * Snippitor - Cinnamon text expander applet
...
MyApplet.prototype = {
    ...
    _init: function(orientation, panel_height, instance_id) {
        ...
        this._toggleItem.connect("activate", Lang.bind(this, this._toggleDaemon));
        this.menu.addMenuItem(this._toggleItem);

        this.menu.addMenuItem(new PopupMenu.PopupSeparatorMenuItem());

        let editItem = new PopupMenu.PopupMenuItem("Edit Expansions...");
        editItem.connect("activate", Lang.bind(this, this._openEditor));
    ...
    _checkStatus: function() {
        try {
            ...
            proc.communicate_utf8_async(null, null, Lang.bind(this, function(source, res) {
                let running = false;
                try {
    ...
    _startDaemon: function() {
        Util.spawnCommandLine("python3 '" + DAEMON_SCRIPT + "'");
        ...
        GLib.timeout_add(GLib.PRIORITY_DEFAULT, 700, Lang.bind(this, function() {
            this._checkStatus();
            return false; // one-shot timeout
        }));
    },
    ...
    _stopDaemon: function() {
        Util.spawnCommandLine("pkill -f '" + DAEMON_SCRIPT + "'");
        this._running = false;
        this._updateUI();
    },

    _openEditor: function() {
        Util.spawnCommandLine("python3 '" + GUI_SCRIPT + "'");
    },
    ...
    on_applet_removed_from_panel: function() {
        ...
        Util.spawnCommandLine("pkill -f '" + GUI_SCRIPT + "'");
        ...
        Util.spawnCommandLine("rm -rf '" + HOME + "/.config/snippitor'");
    }
};
